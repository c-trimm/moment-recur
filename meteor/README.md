Packaging [moment-recur](https://github.com/c-trimm/moment-recur) for [Meteor.js](http://meteor.com) with the dependency on official [momentjs:moment](https://atmospherejs.com/momentjs/moment) package.
